//! `[devices.extra]` and `[devices.channels.extra]` shapes for imu-cora.
//!
//! Parsing is forgiving: missing optional fields fall back to documented
//! defaults. Required fields error out with a clear message identifying the
//! offending channel.
...
#[derive(Debug, Clone)]
pub struct ImuChannelExtra {
    pub cora_topic: String,
    pub cora_qos: Qos,
}

impl ImuChannelExtra {
    pub fn parse(
