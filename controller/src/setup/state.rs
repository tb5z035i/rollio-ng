...
use rollio_types::config::{
    ...
    RobotCommandKind, RobotMode, RobotStateKind, SensorStateKind,
};
...
pub(super) struct DiscoveredChannelMeta {
    ...
    #[serde(default)]
    pub(super) supported_sensor_kinds: Vec<SensorStateKind>,
    ...
    /// IMU samples.
    #[serde(default)]
    pub(super) sensor_shape_hints: std::collections::BTreeMap<SensorStateKind, Vec<u32>>,
