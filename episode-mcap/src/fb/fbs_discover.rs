...
impl<'a> Imu<'a> {
  ...
  pub fn timestamp(&self) -> Option<&'a super::foxglove::Time> {
    ...
    unsafe { self._tab.get::<super::foxglove::Time>(Imu::VT_TIMESTAMP, None)}
  }
  /// Frame of reference
  #[inline]
  pub fn frame_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Imu::VT_FRAME_ID, None)}
  }
  ...
  pub fn orientation(&self) -> Option<super::foxglove::Quaternion<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<super::foxglove::Quaternion>>(Imu::VT_ORIENTATION, None)}
  }
  ...
  pub fn angular_velocity(&self) -> Option<super::foxglove::Vector3<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<super::foxglove::Vector3>>(Imu::VT_ANGULAR_VELOCITY, None)}
  }
  ...
  pub fn linear_acceleration(&self) -> Option<super::foxglove::Vector3<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<super::foxglove::Vector3>>(Imu::VT_LINEAR_ACCELERATION, None)}
  }
}
...
impl ::flatbuffers::Verifiable for Imu<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<super::foxglove::Quaternion>>("orientation", Self::VT_ORIENTATION, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<super::foxglove::Vector3>>("angular_velocity", Self::VT_ANGULAR_VELOCITY, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<super::foxglove::Vector3>>("linear_acceleration", Self::VT_LINEAR_ACCELERATION, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ImuBuilder<'a, 'b, A> {
  ...
  pub fn add_timestamp(&mut self, timestamp: &super::foxglove::Time) {
    self.fbb_.push_slot_always::<&super::foxglove::Time>(Imu::VT_TIMESTAMP, timestamp);
  }
  #[inline]
  pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Imu::VT_FRAME_ID, frame_id);
  }
  #[inline]
  pub fn add_orientation(&mut self, orientation: ::flatbuffers::WIPOffset<super::foxglove::Quaternion<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<super::foxglove::Quaternion>>(Imu::VT_ORIENTATION, orientation);
  }
  #[inline]
  pub fn add_angular_velocity(&mut self, angular_velocity: ::flatbuffers::WIPOffset<super::foxglove::Vector3<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<super::foxglove::Vector3>>(Imu::VT_ANGULAR_VELOCITY, angular_velocity);
  }
  #[inline]
  pub fn add_linear_acceleration(&mut self, linear_acceleration: ::flatbuffers::WIPOffset<super::foxglove::Vector3<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<super::foxglove::Vector3>>(Imu::VT_LINEAR_ACCELERATION, linear_acceleration);
  }
  #[inline]
...
pub fn size_prefixed_root_as_imu(buf: &[u8]) -> Result<Imu<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_imu_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<Imu<'a>>) {
...
impl<'b> ::flatbuffers::Push for TactilePoint {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const TactilePoint as *const u8, <Self as ::flatbuffers::Push>::size()) };
...
impl<'a> TactileData<'a> {
  ...
  pub fn timestamp(&self) -> Option<&'a super::foxglove::Time> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::foxglove::Time>(TactileData::VT_TIMESTAMP, None)}
  }
  /// Frame of reference
  #[inline]
  pub fn frame_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(TactileData::VT_FRAME_ID, None)}
  }
  ...
  pub fn points(&self) -> Option<::flatbuffers::Vector<'a, TactilePoint>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, TactilePoint>>>(TactileData::VT_POINTS, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TactileDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_timestamp(&mut self, timestamp: &super::foxglove::Time) {
    self.fbb_.push_slot_always::<&super::foxglove::Time>(TactileData::VT_TIMESTAMP, timestamp);
  }
  #[inline]
  pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(TactileData::VT_FRAME_ID, frame_id);
  }
  #[inline]
  pub fn add_points(&mut self, points: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , TactilePoint>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(TactileData::VT_POINTS, points);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TactileDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TactileDataBuilder {
      fbb_: _fbb,
      start_: start,
...
pub fn root_as_tactile_data(buf: &[u8]) -> Result<TactileData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tactile_data(buf: &[u8]) -> Result<TactileData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_tactile_data_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<TactileData<'a>>) {
  fbb.finish_size_prefixed(root, None);
}
