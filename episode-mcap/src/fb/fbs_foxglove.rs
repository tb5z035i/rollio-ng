...
pub mod foxglove {
    ...
    impl<'a> ArrowPrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(ArrowPrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn shaft_length(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(ArrowPrimitive::VT_SHAFT_LENGTH, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn shaft_diameter(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(ArrowPrimitive::VT_SHAFT_DIAMETER, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn head_length(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(ArrowPrimitive::VT_HEAD_LENGTH, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn head_diameter(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(ArrowPrimitive::VT_HEAD_DIAMETER, Some(0.0))
                    .unwrap()
            }
        }
        /// Color of the arrow
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(ArrowPrimitive::VT_COLOR, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ArrowPrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(ArrowPrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_shaft_length(&mut self, shaft_length: f64) {
            self.fbb_
                .push_slot::<f64>(ArrowPrimitive::VT_SHAFT_LENGTH, shaft_length, 0.0);
        }
        #[inline]
        pub fn add_shaft_diameter(&mut self, shaft_diameter: f64) {
            self.fbb_
                .push_slot::<f64>(ArrowPrimitive::VT_SHAFT_DIAMETER, shaft_diameter, 0.0);
        }
        #[inline]
        pub fn add_head_length(&mut self, head_length: f64) {
            self.fbb_
                .push_slot::<f64>(ArrowPrimitive::VT_HEAD_LENGTH, head_length, 0.0);
        }
        #[inline]
        pub fn add_head_diameter(&mut self, head_diameter: f64) {
            self.fbb_
                .push_slot::<f64>(ArrowPrimitive::VT_HEAD_DIAMETER, head_diameter, 0.0);
        }
        #[inline]
        pub fn add_color(&mut self, color: ::flatbuffers::WIPOffset<Color<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(
                    ArrowPrimitive::VT_COLOR,
                    color,
                );
        }
        #[inline]
    ...
    pub fn root_as_arrow_primitive(
        buf: &[u8],
    ) -> Result<ArrowPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_arrow_primitive(
        buf: &[u8],
    ) -> Result<ArrowPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_arrow_primitive_unchecked(
        buf: &[u8],
    ) -> ArrowPrimitive<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_arrow_primitive_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<ArrowPrimitive<'a>>,
    ) {
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ByteVectorBuilder<'a, 'b, A> {
        ...
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(ByteVector::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ByteVectorBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            ByteVectorBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_byte_vector(
        buf: &[u8],
    ) -> Result<ByteVector<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_byte_vector(
        buf: &[u8],
    ) -> Result<ByteVector<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_byte_vector_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<ByteVector<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> CameraCalibration<'a> {
        ...
        >(
            ...
            if let Some(x) = args.distortion_model {
                builder.add_distortion_model(x);
            }
        ...
        pub fn width(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(CameraCalibration::VT_WIDTH, Some(0))
                    .unwrap()
            }
        }
        /// Image height
        ...
        pub fn height(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(CameraCalibration::VT_HEIGHT, Some(0))
                    .unwrap()
            }
        }
        ...
        pub fn distortion_model(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                    CameraCalibration::VT_DISTORTION_MODEL,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CameraCalibrationBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(CameraCalibration::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        ...
        pub fn add_width(&mut self, width: u32) {
            self.fbb_
                .push_slot::<u32>(CameraCalibration::VT_WIDTH, width, 0);
        }
        #[inline]
        pub fn add_height(&mut self, height: u32) {
            self.fbb_
                .push_slot::<u32>(CameraCalibration::VT_HEIGHT, height, 0);
        }
        #[inline]
        pub fn add_distortion_model(
            &mut self,
            distortion_model: ::flatbuffers::WIPOffset<&'b str>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CameraCalibration::VT_DISTORTION_MODEL,
                distortion_model,
        ...
        pub fn add_d(&mut self, d: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CameraCalibration::VT_D, d);
        }
        #[inline]
        pub fn add_k(&mut self, k: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CameraCalibration::VT_K, k);
        }
        #[inline]
        pub fn add_r(&mut self, r: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CameraCalibration::VT_R, r);
        }
        #[inline]
        pub fn add_p(&mut self, p: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CameraCalibration::VT_P, p);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> CameraCalibrationBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_camera_calibration(
        buf: &[u8],
    ) -> Result<CameraCalibration<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_camera_calibration(
        buf: &[u8],
    ) -> Result<CameraCalibration<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_camera_calibration_unchecked(
        buf: &[u8],
    ) -> CameraCalibration<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_camera_calibration_buffer<
        'a,
        'b,
    ...
    impl<'a> CircleAnnotation<'a> {
        ...
        >(
            ...
            if let Some(x) = args.outline_color {
                builder.add_outline_color(x);
            }
            if let Some(x) = args.fill_color {
                builder.add_fill_color(x);
            }
        ...
        pub fn position(&self) -> Option<Point2<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Point2>>(
                    CircleAnnotation::VT_POSITION,
                    None,
                )
            }
        }
        ...
        pub fn diameter(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(CircleAnnotation::VT_DIAMETER, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn thickness(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(CircleAnnotation::VT_THICKNESS, Some(0.0))
                    .unwrap()
            }
        }
        /// Fill color
        ...
        pub fn fill_color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    CircleAnnotation::VT_FILL_COLOR,
                    None,
                )
            }
        }
        ...
        pub fn outline_color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    CircleAnnotation::VT_OUTLINE_COLOR,
                    None,
                )
            }
        }
        ...
        pub fn metadata(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
                >>(CircleAnnotation::VT_METADATA, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for CircleAnnotation<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<Time>("timestamp", Self::VT_TIMESTAMP, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Point2>>(
                    "position",
                    Self::VT_POSITION,
                    false,
                )?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<Color>>(
                    "outline_color",
                    Self::VT_OUTLINE_COLOR,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
    ...
    pub struct CircleAnnotationArgs<'a> {
        ...
        pub metadata: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CircleAnnotationBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(CircleAnnotation::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_position(&mut self, position: ::flatbuffers::WIPOffset<Point2<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Point2>>(
                    CircleAnnotation::VT_POSITION,
                    position,
                );
        }
        ...
        pub fn add_diameter(&mut self, diameter: f64) {
            self.fbb_
                .push_slot::<f64>(CircleAnnotation::VT_DIAMETER, diameter, 0.0);
        }
        #[inline]
        pub fn add_thickness(&mut self, thickness: f64) {
            self.fbb_
                .push_slot::<f64>(CircleAnnotation::VT_THICKNESS, thickness, 0.0);
        }
        #[inline]
        ...
        pub fn add_metadata(
            ...
            metadata: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<KeyValuePair<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CircleAnnotation::VT_METADATA,
                metadata,
            );
        }
        #[inline]
    ...
    pub fn root_as_circle_annotation(
        buf: &[u8],
    ) -> Result<CircleAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_circle_annotation(
        buf: &[u8],
    ) -> Result<CircleAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_circle_annotation_unchecked(
        buf: &[u8],
    ) -> CircleAnnotation<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_circle_annotation_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    pub fn size_prefixed_root_as_color(
        buf: &[u8],
    ) -> Result<Color<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_color_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Color<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> CompressedImage<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(CompressedImage::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn format(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(CompressedImage::VT_FORMAT, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CompressedImageBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(CompressedImage::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CompressedImage::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CompressedImage::VT_DATA, data);
        }
        #[inline]
        pub fn add_format(&mut self, format: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CompressedImage::VT_FORMAT,
                format,
            );
        }
        #[inline]
    ...
    pub fn root_as_compressed_image(
        buf: &[u8],
    ) -> Result<CompressedImage<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_compressed_image(
        buf: &[u8],
    ) -> Result<CompressedImage<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_compressed_image_unchecked(
        buf: &[u8],
    ) -> CompressedImage<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_compressed_image_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> CompressedPointCloud<'a> {
        ...
        pub fn timestamp(&self) -> Option<&'a Time> {
            ...
            unsafe {
                self._tab
                    .get::<Time>(CompressedPointCloud::VT_TIMESTAMP, None)
            }
        }
        /// Frame of reference
        #[inline]
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                    CompressedPointCloud::VT_FRAME_ID,
                    None,
                )
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Pose>>(
                    CompressedPointCloud::VT_POSE,
                    None,
                )
            }
        }
        ...
        pub fn format(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                    CompressedPointCloud::VT_FORMAT,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CompressedPointCloudBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(CompressedPointCloud::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(
                    CompressedPointCloud::VT_POSE,
                    pose,
                );
        }
        ...
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> CompressedPointCloudBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_compressed_point_cloud(
        buf: &[u8],
    ) -> Result<CompressedPointCloud<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_compressed_point_cloud(
        buf: &[u8],
    ) -> Result<CompressedPointCloud<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_compressed_point_cloud_unchecked(
        buf: &[u8],
    ) -> CompressedPointCloud<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_compressed_point_cloud_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> CompressedVideo<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(CompressedVideo::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn format(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(CompressedVideo::VT_FORMAT, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CompressedVideoBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(CompressedVideo::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CompressedVideo::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(CompressedVideo::VT_DATA, data);
        }
        #[inline]
        pub fn add_format(&mut self, format: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                CompressedVideo::VT_FORMAT,
                format,
            );
        }
        #[inline]
    ...
    pub fn root_as_compressed_video(
        buf: &[u8],
    ) -> Result<CompressedVideo<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_compressed_video(
        buf: &[u8],
    ) -> Result<CompressedVideo<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_compressed_video_unchecked(
        buf: &[u8],
    ) -> CompressedVideo<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_compressed_video_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> CubePrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(CubePrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn size(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(CubePrimitive::VT_SIZE, None)
            }
        }
        /// Color of the cube
        #[inline]
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(CubePrimitive::VT_COLOR, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for CubePrimitive<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Pose>>("pose", Self::VT_POSE, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Vector3>>(
                    "size",
                    Self::VT_SIZE,
                    false,
                )?
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CubePrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(CubePrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_size(&mut self, size: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    CubePrimitive::VT_SIZE,
                    size,
                );
        }
        #[inline]
    ...
    pub fn root_as_cube_primitive(
        buf: &[u8],
    ) -> Result<CubePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_cube_primitive(
        buf: &[u8],
    ) -> Result<CubePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_cube_primitive_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<CubePrimitive<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> CylinderPrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(CylinderPrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn size(&self) -> Option<Vector3<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Vector3>>(
                    CylinderPrimitive::VT_SIZE,
                    None,
                )
            }
        }
        ...
        pub fn bottom_scale(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(CylinderPrimitive::VT_BOTTOM_SCALE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn top_scale(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(CylinderPrimitive::VT_TOP_SCALE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(CylinderPrimitive::VT_COLOR, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CylinderPrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_bottom_scale(&mut self, bottom_scale: f64) {
            self.fbb_
                .push_slot::<f64>(CylinderPrimitive::VT_BOTTOM_SCALE, bottom_scale, 0.0);
        }
        #[inline]
        pub fn add_top_scale(&mut self, top_scale: f64) {
            self.fbb_
                .push_slot::<f64>(CylinderPrimitive::VT_TOP_SCALE, top_scale, 0.0);
        }
        #[inline]
        pub fn add_color(&mut self, color: ::flatbuffers::WIPOffset<Color<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(
                    CylinderPrimitive::VT_COLOR,
                    color,
                );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> CylinderPrimitiveBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_cylinder_primitive(
        buf: &[u8],
    ) -> Result<CylinderPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_cylinder_primitive(
        buf: &[u8],
    ) -> Result<CylinderPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_cylinder_primitive_unchecked(
        buf: &[u8],
    ) -> CylinderPrimitive<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_cylinder_primitive_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> FrameTransform<'a> {
        ...
        >(
            ...
            if let Some(x) = args.child_frame_id {
                builder.add_child_frame_id(x);
            }
            if let Some(x) = args.parent_frame_id {
                builder.add_parent_frame_id(x);
            }
            if let Some(x) = args.timestamp {
                builder.add_timestamp(x);
            }
        ...
        pub fn parent_frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                    FrameTransform::VT_PARENT_FRAME_ID,
                    None,
                )
            }
        }
        ...
        pub fn child_frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                    FrameTransform::VT_CHILD_FRAME_ID,
                    None,
                )
            }
        }
        ...
        pub fn rotation(&self) -> Option<Quaternion<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Quaternion>>(
                    FrameTransform::VT_ROTATION,
                    None,
                )
            }
        }
    ...
    impl ::flatbuffers::Verifiable for FrameTransform<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                    "parent_frame_id",
                    Self::VT_PARENT_FRAME_ID,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                    "child_frame_id",
                    Self::VT_CHILD_FRAME_ID,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<Vector3>>(
                    "translation",
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<Quaternion>>(
                    "rotation",
                    Self::VT_ROTATION,
                    false,
                )?
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FrameTransformBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(FrameTransform::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        ...
        pub fn add_rotation(&mut self, rotation: ::flatbuffers::WIPOffset<Quaternion<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Quaternion>>(
                    FrameTransform::VT_ROTATION,
                    rotation,
                );
        }
    ...
    pub fn root_as_frame_transform(
        buf: &[u8],
    ) -> Result<FrameTransform<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_frame_transform(
        buf: &[u8],
    ) -> Result<FrameTransform<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_frame_transform_unchecked(
        buf: &[u8],
    ) -> FrameTransform<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_frame_transform_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<FrameTransform<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> FrameTransforms<'a> {
        ...
        pub fn transforms(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FrameTransform<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FrameTransform>>,
                >>(FrameTransforms::VT_TRANSFORMS, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for FrameTransforms<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<FrameTransform>>,
                >>("transforms", Self::VT_TRANSFORMS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct FrameTransformsArgs<'a> {
        pub transforms: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<FrameTransform<'a>>>,
            >,
        >,
    }
    impl<'a> Default for FrameTransformsArgs<'a> {
        #[inline]
        fn default() -> Self {
            FrameTransformsArgs { transforms: None }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FrameTransformsBuilder<'a, 'b, A> {
        ...
        pub fn add_transforms(
            ...
            transforms: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<FrameTransform<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                FrameTransforms::VT_TRANSFORMS,
                transforms,
            );
        }
        #[inline]
    ...
    pub fn root_as_frame_transforms(
        buf: &[u8],
    ) -> Result<FrameTransforms<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_frame_transforms(
        buf: &[u8],
    ) -> Result<FrameTransforms<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_frame_transforms_unchecked(
        buf: &[u8],
    ) -> FrameTransforms<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_frame_transforms_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> GeoJSON<'a> {
        ...
        >(
            ...
            if let Some(x) = args.geojson {
                builder.add_geojson(x);
            }
            builder.finish()
        }
        ...
        pub fn geojson(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(GeoJSON::VT_GEOJSON, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GeoJSONBuilder<'a, 'b, A> {
        ...
        pub fn add_geojson(&mut self, geojson: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(GeoJSON::VT_GEOJSON, geojson);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> GeoJSONBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            GeoJSONBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_geo_json(
        buf: &[u8],
    ) -> Result<GeoJSON<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_geo_json_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<GeoJSON<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> Grid<'a> {
        ...
        >(
            ...
            if let Some(x) = args.cell_size {
                builder.add_cell_size(x);
            }
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Grid::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(Grid::VT_POSE, None)
            }
        }
        ...
        pub fn column_count(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(Grid::VT_COLUMN_COUNT, Some(0))
                    .unwrap()
            }
        }
        ...
        pub fn cell_size(&self) -> Option<Vector2<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector2>>(Grid::VT_CELL_SIZE, None)
            }
        }
        ...
        pub fn fields(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PackedElementField<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PackedElementField>>,
                >>(Grid::VT_FIELDS, None)
            }
        }
    ...
    impl ::flatbuffers::Verifiable for Grid<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<Vector2>>(
                    "cell_size",
                    Self::VT_CELL_SIZE,
                    false,
                )?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<PackedElementField>>,
    ...
    pub struct GridArgs<'a> {
        ...
        pub fields: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PackedElementField<'a>>>,
            >,
        >,
        pub data: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, u8>>>,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GridBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(Grid::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Grid::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(Grid::VT_POSE, pose);
        }
        #[inline]
        pub fn add_column_count(&mut self, column_count: u32) {
            self.fbb_
                .push_slot::<u32>(Grid::VT_COLUMN_COUNT, column_count, 0);
        }
        #[inline]
        pub fn add_cell_size(&mut self, cell_size: ::flatbuffers::WIPOffset<Vector2<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector2>>(
                    Grid::VT_CELL_SIZE,
                    cell_size,
                );
        }
        ...
        pub fn add_row_stride(&mut self, row_stride: u32) {
            self.fbb_
                .push_slot::<u32>(Grid::VT_ROW_STRIDE, row_stride, 0);
        }
        #[inline]
        pub fn add_cell_stride(&mut self, cell_stride: u32) {
            self.fbb_
                .push_slot::<u32>(Grid::VT_CELL_STRIDE, cell_stride, 0);
        }
        #[inline]
        pub fn add_fields(
            &mut self,
            fields: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<PackedElementField<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Grid::VT_FIELDS, fields);
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Grid::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    pub fn size_prefixed_root_as_grid(
        buf: &[u8],
    ) -> Result<Grid<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_grid_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Grid<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> ImageAnnotations<'a> {
        ...
        >(
            ...
            if let Some(x) = args.texts {
                builder.add_texts(x);
            }
            if let Some(x) = args.points {
                builder.add_points(x);
            }
            if let Some(x) = args.circles {
                builder.add_circles(x);
            }
            builder.finish()
        }
        ...
        pub fn circles(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CircleAnnotation<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CircleAnnotation>>,
                >>(ImageAnnotations::VT_CIRCLES, None)
            }
        }
        /// Points annotations
        #[inline]
        pub fn points(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PointsAnnotation<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PointsAnnotation>>,
                >>(ImageAnnotations::VT_POINTS, None)
            }
        }
        /// Text annotations
        #[inline]
        pub fn texts(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextAnnotation<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextAnnotation>>,
                >>(ImageAnnotations::VT_TEXTS, None)
            }
        }
        ...
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair<'a>>>>
        {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
                >>(ImageAnnotations::VT_METADATA, None)
            }
        }
    ...
    impl ::flatbuffers::Verifiable for ImageAnnotations<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<CircleAnnotation>>,
                >>("circles", Self::VT_CIRCLES, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<PointsAnnotation>>,
                >>("points", Self::VT_POINTS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<TextAnnotation>>,
                >>("texts", Self::VT_TEXTS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
                >>("metadata", Self::VT_METADATA, false)?
                .visit_field::<Time>("timestamp", Self::VT_TIMESTAMP, false)?
    ...
    pub struct ImageAnnotationsArgs<'a> {
        pub circles: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CircleAnnotation<'a>>>,
            >,
        >,
        pub points: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<PointsAnnotation<'a>>>,
            >,
        >,
        pub texts: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextAnnotation<'a>>>,
            >,
        >,
        pub metadata: Option<
            ::flatbuffers::WIPOffset<
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ImageAnnotationsBuilder<'a, 'b, A> {
        ...
        pub fn add_circles(
            &mut self,
            circles: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<CircleAnnotation<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                ImageAnnotations::VT_CIRCLES,
                circles,
            );
        }
        #[inline]
        pub fn add_points(
            ...
            points: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<PointsAnnotation<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                ImageAnnotations::VT_POINTS,
                points,
            );
        }
        #[inline]
        pub fn add_texts(
            &mut self,
            texts: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<TextAnnotation<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(ImageAnnotations::VT_TEXTS, texts);
        }
        #[inline]
        pub fn add_metadata(
            &mut self,
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(ImageAnnotations::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ImageAnnotationsBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_image_annotations(
        buf: &[u8],
    ) -> Result<ImageAnnotations<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_image_annotations(
        buf: &[u8],
    ) -> Result<ImageAnnotations<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_image_annotations_unchecked(
        buf: &[u8],
    ) -> ImageAnnotations<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_image_annotations_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> JointState<'a> {
        ...
        >(
            ...
            if let Some(x) = args.effort {
                builder.add_effort(x);
            }
            if let Some(x) = args.acceleration {
                builder.add_acceleration(x);
            }
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(JointState::VT_NAME, None)
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> JointStateBuilder<'a, 'b, A> {
        ...
        pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(JointState::VT_NAME, name);
        }
        #[inline]
        pub fn add_position(&mut self, position: f64) {
            self.fbb_
                .push_slot_always::<f64>(JointState::VT_POSITION, position);
        }
        #[inline]
        pub fn add_velocity(&mut self, velocity: f64) {
            self.fbb_
                .push_slot_always::<f64>(JointState::VT_VELOCITY, velocity);
        }
        #[inline]
        pub fn add_acceleration(&mut self, acceleration: f64) {
            self.fbb_
                .push_slot_always::<f64>(JointState::VT_ACCELERATION, acceleration);
        }
        #[inline]
        pub fn add_effort(&mut self, effort: f64) {
            self.fbb_
                .push_slot_always::<f64>(JointState::VT_EFFORT, effort);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> JointStateBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            JointStateBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_joint_state(
        buf: &[u8],
    ) -> Result<JointState<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_joint_state(
        buf: &[u8],
    ) -> Result<JointState<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_joint_state_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<JointState<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> JointStates<'a> {
        ...
        >(
            ...
            if let Some(x) = args.joints {
                builder.add_joints(x);
            }
            if let Some(x) = args.timestamp {
                builder.add_timestamp(x);
            }
        ...
        pub fn joints(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<JointState<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<JointState>>,
                >>(JointStates::VT_JOINTS, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for JointStates<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<Time>("timestamp", Self::VT_TIMESTAMP, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<JointState>>,
                >>("joints", Self::VT_JOINTS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct JointStatesArgs<'a> {
        ...
        pub joints: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<JointState<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> JointStatesBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(JointStates::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_joints(
            &mut self,
            joints: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<JointState<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(JointStates::VT_JOINTS, joints);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> JointStatesBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            JointStatesBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_joint_states(
        buf: &[u8],
    ) -> Result<JointStates<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_joint_states(
        buf: &[u8],
    ) -> Result<JointStates<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_joint_states_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<JointStates<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> KeyValuePair<'a> {
        ...
        pub fn key(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(KeyValuePair::VT_KEY, None)
            }
        }
        /// Value
        #[inline]
        pub fn value(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(KeyValuePair::VT_VALUE, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KeyValuePairBuilder<'a, 'b, A> {
        ...
        pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(KeyValuePair::VT_KEY, key);
        }
        #[inline]
        pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(KeyValuePair::VT_VALUE, value);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> KeyValuePairBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            KeyValuePairBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_key_value_pair(
        buf: &[u8],
    ) -> Result<KeyValuePair<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_key_value_pair(
        buf: &[u8],
    ) -> Result<KeyValuePair<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_key_value_pair_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<KeyValuePair<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> LaserScan<'a> {
        ...
        >(
            ...
            if let Some(x) = args.intensities {
                builder.add_intensities(x);
            }
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(LaserScan::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(LaserScan::VT_POSE, None)
            }
        }
        ...
        pub fn start_angle(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LaserScan::VT_START_ANGLE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn end_angle(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LaserScan::VT_END_ANGLE, Some(0.0))
                    .unwrap()
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LaserScanBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(LaserScan::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(LaserScan::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(LaserScan::VT_POSE, pose);
        }
        #[inline]
        pub fn add_start_angle(&mut self, start_angle: f64) {
            self.fbb_
                .push_slot::<f64>(LaserScan::VT_START_ANGLE, start_angle, 0.0);
        }
        #[inline]
        pub fn add_end_angle(&mut self, end_angle: f64) {
            self.fbb_
                .push_slot::<f64>(LaserScan::VT_END_ANGLE, end_angle, 0.0);
        }
        #[inline]
        pub fn add_ranges(
            &mut self,
            ranges: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(LaserScan::VT_RANGES, ranges);
        }
        #[inline]
        pub fn add_intensities(
            &mut self,
            intensities: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                LaserScan::VT_INTENSITIES,
                intensities,
    ...
    pub fn root_as_laser_scan(
        buf: &[u8],
    ) -> Result<LaserScan<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_laser_scan(
        buf: &[u8],
    ) -> Result<LaserScan<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_laser_scan_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<LaserScan<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl LineType {
        ...
        pub const ENUM_VALUES: &'static [Self] =
            &[Self::LINE_STRIP, Self::LINE_LOOP, Self::LINE_LIST];
    ...
    impl<'a> LinePrimitive<'a> {
        ...
        pub fn type_(&self) -> LineType {
            ...
            unsafe {
                self._tab
                    .get::<LineType>(LinePrimitive::VT_TYPE_, Some(LineType::LINE_STRIP))
                    .unwrap()
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(LinePrimitive::VT_POSE, None)
            }
        }
        /// Line thickness
        #[inline]
        pub fn thickness(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LinePrimitive::VT_THICKNESS, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn scale_invariant(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(LinePrimitive::VT_SCALE_INVARIANT, Some(false))
                    .unwrap()
            }
        }
        ...
        pub fn points(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point3<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point3>>,
                >>(LinePrimitive::VT_POINTS, None)
            }
        }
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(LinePrimitive::VT_COLOR, None)
            }
        }
        ...
        pub fn colors(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color>>,
                >>(LinePrimitive::VT_COLORS, None)
            }
        }
    ...
    impl ::flatbuffers::Verifiable for LinePrimitive<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Point3>>,
                >>("points", Self::VT_POINTS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Color>>(
                    "color",
                    Self::VT_COLOR,
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Color>>,
                >>("colors", Self::VT_COLORS, false)?
    ...
    pub struct LinePrimitiveArgs<'a> {
        ...
        pub points: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point3<'a>>>,
            >,
        >,
        pub color: Option<::flatbuffers::WIPOffset<Color<'a>>>,
        pub colors: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color<'a>>>,
            >,
        >,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LinePrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_type_(&mut self, type_: LineType) {
            self.fbb_
                .push_slot::<LineType>(LinePrimitive::VT_TYPE_, type_, LineType::LINE_STRIP);
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(LinePrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_thickness(&mut self, thickness: f64) {
            self.fbb_
                .push_slot::<f64>(LinePrimitive::VT_THICKNESS, thickness, 0.0);
        }
        #[inline]
        pub fn add_scale_invariant(&mut self, scale_invariant: bool) {
            self.fbb_
                .push_slot::<bool>(LinePrimitive::VT_SCALE_INVARIANT, scale_invariant, false);
        }
        #[inline]
        pub fn add_points(
            &mut self,
            points: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Point3<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(LinePrimitive::VT_POINTS, points);
        }
        #[inline]
        pub fn add_color(&mut self, color: ::flatbuffers::WIPOffset<Color<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(
                    LinePrimitive::VT_COLOR,
                    color,
                );
        }
        #[inline]
        pub fn add_colors(
            &mut self,
            colors: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Color<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(LinePrimitive::VT_COLORS, colors);
        }
        #[inline]
        pub fn add_indices(
            &mut self,
    ...
    pub fn root_as_line_primitive(
        buf: &[u8],
    ) -> Result<LinePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_line_primitive(
        buf: &[u8],
    ) -> Result<LinePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_line_primitive_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<LinePrimitive<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> LocationFix<'a> {
        ...
        >(
            ...
            if let Some(x) = args.heading {
                builder.add_heading(x);
            }
            ...
            if let Some(x) = args.position_covariance {
                builder.add_position_covariance(x);
            }
            if let Some(x) = args.frame_id {
                builder.add_frame_id(x);
            }
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(LocationFix::VT_FRAME_ID, None)
            }
        }
        /// Latitude in degrees
        #[inline]
        pub fn latitude(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LocationFix::VT_LATITUDE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn longitude(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LocationFix::VT_LONGITUDE, Some(0.0))
                    .unwrap()
            }
        }
        /// Altitude in meters
        ...
        pub fn altitude(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(LocationFix::VT_ALTITUDE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn position_covariance(&self) -> Option<::flatbuffers::Vector<'a, f64>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, f64>>>(
                        LocationFix::VT_POSITION_COVARIANCE,
                        None,
                    )
            }
        }
        ...
        pub fn position_covariance_type(&self) -> PositionCovarianceType {
            ...
            unsafe {
                self._tab
                    .get::<PositionCovarianceType>(
                        LocationFix::VT_POSITION_COVARIANCE_TYPE,
                        Some(PositionCovarianceType::UNKNOWN),
                    )
                    .unwrap()
            }
        }
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(LocationFix::VT_COLOR, None)
            }
        }
        ...
        pub fn velocity(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(LocationFix::VT_VELOCITY, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for LocationFix<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, f64>>>(
                    "position_covariance",
                    Self::VT_POSITION_COVARIANCE,
                    false,
                )?
                .visit_field::<PositionCovarianceType>(
                    "position_covariance_type",
                    Self::VT_POSITION_COVARIANCE_TYPE,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<Color>>(
                    "color",
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LocationFixBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(LocationFix::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                LocationFix::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_latitude(&mut self, latitude: f64) {
            self.fbb_
                .push_slot::<f64>(LocationFix::VT_LATITUDE, latitude, 0.0);
        }
        #[inline]
        pub fn add_longitude(&mut self, longitude: f64) {
            self.fbb_
                .push_slot::<f64>(LocationFix::VT_LONGITUDE, longitude, 0.0);
        }
        #[inline]
        pub fn add_altitude(&mut self, altitude: f64) {
            self.fbb_
                .push_slot::<f64>(LocationFix::VT_ALTITUDE, altitude, 0.0);
        }
        #[inline]
        pub fn add_position_covariance(
            &mut self,
            position_covariance: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                LocationFix::VT_POSITION_COVARIANCE,
                position_covariance,
        ...
        #[inline]
        pub fn add_position_covariance_type(
            &mut self,
            position_covariance_type: PositionCovarianceType,
        ) {
            self.fbb_.push_slot::<PositionCovarianceType>(
                LocationFix::VT_POSITION_COVARIANCE_TYPE,
                position_covariance_type,
                PositionCovarianceType::UNKNOWN,
            );
        ...
        pub fn add_color(&mut self, color: ::flatbuffers::WIPOffset<Color<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(LocationFix::VT_COLOR, color);
        }
        #[inline]
        pub fn add_metadata(
            &mut self,
        ...
        pub fn add_heading(&mut self, heading: f64) {
            self.fbb_
                .push_slot_always::<f64>(LocationFix::VT_HEADING, heading);
        }
        #[inline]
        pub fn add_velocity(&mut self, velocity: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    LocationFix::VT_VELOCITY,
                    velocity,
                );
        }
        #[inline]
    ...
    pub fn root_as_location_fix(
        buf: &[u8],
    ) -> Result<LocationFix<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_location_fix(
        buf: &[u8],
    ) -> Result<LocationFix<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_location_fix_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<LocationFix<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> LocationFixes<'a> {
        ...
        pub fn fixes(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LocationFix<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LocationFix>>,
                >>(LocationFixes::VT_FIXES, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for LocationFixes<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<LocationFix>>,
                >>("fixes", Self::VT_FIXES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct LocationFixesArgs<'a> {
        pub fixes: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LocationFix<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LocationFixesBuilder<'a, 'b, A> {
        ...
        pub fn add_fixes(
            &mut self,
            fixes: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<LocationFix<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(LocationFixes::VT_FIXES, fixes);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> LocationFixesBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_location_fixes(
        buf: &[u8],
    ) -> Result<LocationFixes<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_location_fixes(
        buf: &[u8],
    ) -> Result<LocationFixes<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_location_fixes_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<LocationFixes<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> Log<'a> {
        ...
        pub fn level(&self) -> LogLevel {
            ...
            unsafe {
                self._tab
                    .get::<LogLevel>(Log::VT_LEVEL, Some(LogLevel::UNKNOWN))
                    .unwrap()
            }
        }
        /// Log message
        ...
        pub fn message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Log::VT_MESSAGE, None)
            }
        }
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Log::VT_NAME, None)
            }
        }
        /// Filename
        #[inline]
        pub fn file(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Log::VT_FILE, None)
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LogBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(Log::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_level(&mut self, level: LogLevel) {
            self.fbb_
                .push_slot::<LogLevel>(Log::VT_LEVEL, level, LogLevel::UNKNOWN);
        }
        #[inline]
        pub fn add_message(&mut self, message: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Log::VT_MESSAGE, message);
        }
        #[inline]
        pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Log::VT_NAME, name);
        }
        #[inline]
        pub fn add_file(&mut self, file: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Log::VT_FILE, file);
        }
        #[inline]
    ...
    pub fn size_prefixed_root_as_log(
        buf: &[u8],
    ) -> Result<Log<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_log_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Log<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> ModelPrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(ModelPrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn scale(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(ModelPrimitive::VT_SCALE, None)
            }
        }
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(ModelPrimitive::VT_COLOR, None)
            }
        }
        ...
        pub fn override_color(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(ModelPrimitive::VT_OVERRIDE_COLOR, Some(false))
                    .unwrap()
            }
        }
        ...
        pub fn url(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(ModelPrimitive::VT_URL, None)
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ModelPrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(ModelPrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_scale(&mut self, scale: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    ModelPrimitive::VT_SCALE,
                    scale,
                );
        }
        #[inline]
        ...
        pub fn add_override_color(&mut self, override_color: bool) {
            self.fbb_
                .push_slot::<bool>(ModelPrimitive::VT_OVERRIDE_COLOR, override_color, false);
        }
        #[inline]
        pub fn add_url(&mut self, url: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(ModelPrimitive::VT_URL, url);
        }
        #[inline]
        ...
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(ModelPrimitive::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ModelPrimitiveBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_model_primitive(
        buf: &[u8],
    ) -> Result<ModelPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_model_primitive(
        buf: &[u8],
    ) -> Result<ModelPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_model_primitive_unchecked(
        buf: &[u8],
    ) -> ModelPrimitive<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_model_primitive_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<ModelPrimitive<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> Odometry<'a> {
        ...
        >(
            ...
            if let Some(x) = args.velocity_covariance {
                builder.add_velocity_covariance(x);
            }
            if let Some(x) = args.pose_covariance {
                builder.add_pose_covariance(x);
            }
            if let Some(x) = args.angular_velocity {
                builder.add_angular_velocity(x);
            }
            if let Some(x) = args.linear_velocity {
                builder.add_linear_velocity(x);
            }
            if let Some(x) = args.pose {
                builder.add_pose(x);
            }
            if let Some(x) = args.body_frame_id {
                builder.add_body_frame_id(x);
            }
            if let Some(x) = args.frame_id {
                builder.add_frame_id(x);
            }
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Odometry::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn body_frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Odometry::VT_BODY_FRAME_ID, None)
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(Odometry::VT_POSE, None)
            }
        }
        ...
        pub fn velocity_covariance(&self) -> Option<::flatbuffers::Vector<'a, f64>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, f64>>>(
                        Odometry::VT_VELOCITY_COVARIANCE,
                        None,
                    )
            }
        }
    ...
    impl ::flatbuffers::Verifiable for Odometry<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                    "body_frame_id",
                    Self::VT_BODY_FRAME_ID,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<Pose>>("pose", Self::VT_POSE, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Vector3>>(
                    "linear_velocity",
                    Self::VT_LINEAR_VELOCITY,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<Vector3>>(
                    "angular_velocity",
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, f64>>>(
                    "pose_covariance",
                    Self::VT_POSE_COVARIANCE,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, f64>>>(
                    "velocity_covariance",
                    Self::VT_VELOCITY_COVARIANCE,
                    false,
                )?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> OdometryBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(Odometry::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Odometry::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_body_frame_id(&mut self, body_frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Odometry::VT_BODY_FRAME_ID,
                body_frame_id,
            );
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(Odometry::VT_POSE, pose);
        }
        #[inline]
        pub fn add_linear_velocity(
            &mut self,
            linear_velocity: ::flatbuffers::WIPOffset<Vector3<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    Odometry::VT_LINEAR_VELOCITY,
        ...
        pub fn add_angular_velocity(
            &mut self,
            angular_velocity: ::flatbuffers::WIPOffset<Vector3<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    Odometry::VT_ANGULAR_VELOCITY,
        ...
        #[inline]
        pub fn add_pose_covariance(
            &mut self,
            pose_covariance: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Odometry::VT_POSE_COVARIANCE,
                pose_covariance,
        ...
        #[inline]
        pub fn add_velocity_covariance(
            &mut self,
            velocity_covariance: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, f64>>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Odometry::VT_VELOCITY_COVARIANCE,
                velocity_covariance,
        ...
        pub fn add_metadata(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Odometry::VT_METADATA, metadata);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> OdometryBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            OdometryBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_odometry(
        buf: &[u8],
    ) -> Result<Odometry<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_odometry_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Odometry<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> PackedElementField<'a> {
        ...
        pub fn name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(PackedElementField::VT_NAME, None)
            }
        }
        ...
        pub fn offset(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(PackedElementField::VT_OFFSET, Some(0))
                    .unwrap()
            }
        }
        ...
        pub fn type_(&self) -> NumericType {
            ...
            unsafe {
                self._tab
                    .get::<NumericType>(PackedElementField::VT_TYPE_, Some(NumericType::UNKNOWN))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PackedElementFieldBuilder<'a, 'b, A> {
        ...
        pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(PackedElementField::VT_NAME, name);
        }
        #[inline]
        pub fn add_offset(&mut self, offset: u32) {
            self.fbb_
                .push_slot::<u32>(PackedElementField::VT_OFFSET, offset, 0);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: NumericType) {
            self.fbb_.push_slot::<NumericType>(
                PackedElementField::VT_TYPE_,
                type_,
                NumericType::UNKNOWN,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> PackedElementFieldBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_packed_element_field(
        buf: &[u8],
    ) -> Result<PackedElementField<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_packed_element_field(
        buf: &[u8],
    ) -> Result<PackedElementField<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_packed_element_field_unchecked(
        buf: &[u8],
    ) -> PackedElementField<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_packed_element_field_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    pub fn size_prefixed_root_as_point_2(
        buf: &[u8],
    ) -> Result<Point2<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_point_2_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Point2<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> Point3InFrame<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Point3InFrame::VT_FRAME_ID, None)
            }
        }
        /// Point in 3D space
        #[inline]
        pub fn point(&self) -> Option<Point3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Point3>>(Point3InFrame::VT_POINT, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for Point3InFrame<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<Point3>>(
                    "point",
                    Self::VT_POINT,
                    false,
                )?
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> Point3InFrameBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(Point3InFrame::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Point3InFrame::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_point(&mut self, point: ::flatbuffers::WIPOffset<Point3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Point3>>(
                    Point3InFrame::VT_POINT,
                    point,
                );
        }
        #[inline]
    ...
    pub fn root_as_point_3_in_frame(
        buf: &[u8],
    ) -> Result<Point3InFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_point_3_in_frame(
        buf: &[u8],
    ) -> Result<Point3InFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_point_3_in_frame_unchecked(
        buf: &[u8],
    ) -> Point3InFrame<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_point_3_in_frame_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    pub fn size_prefixed_root_as_point_3(
        buf: &[u8],
    ) -> Result<Point3<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_point_3_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Point3<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> PointCloud<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(PointCloud::VT_FRAME_ID, None)
            }
        }
        /// The origin of the point cloud relative to the frame of reference
        #[inline]
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(PointCloud::VT_POSE, None)
            }
        }
        ...
        pub fn point_stride(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(PointCloud::VT_POINT_STRIDE, Some(0))
                    .unwrap()
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PointCloudBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(PointCloud::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(PointCloud::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(PointCloud::VT_POSE, pose);
        }
        #[inline]
        pub fn add_point_stride(&mut self, point_stride: u32) {
            self.fbb_
                .push_slot::<u32>(PointCloud::VT_POINT_STRIDE, point_stride, 0);
        }
        #[inline]
        pub fn add_fields(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(PointCloud::VT_FIELDS, fields);
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(PointCloud::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> PointCloudBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            PointCloudBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_point_cloud(
        buf: &[u8],
    ) -> Result<PointCloud<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_point_cloud(
        buf: &[u8],
    ) -> Result<PointCloud<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_point_cloud_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<PointCloud<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> PointsAnnotation<'a> {
        ...
        >(
            ...
            if let Some(x) = args.outline_colors {
                builder.add_outline_colors(x);
            }
            if let Some(x) = args.outline_color {
                builder.add_outline_color(x);
            }
        ...
        pub fn type_(&self) -> PointsAnnotationType {
            ...
            unsafe {
                self._tab
                    .get::<PointsAnnotationType>(
                        PointsAnnotation::VT_TYPE_,
                        Some(PointsAnnotationType::UNKNOWN),
                    )
                    .unwrap()
            }
        }
        ...
        pub fn points(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point2<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point2>>,
                >>(PointsAnnotation::VT_POINTS, None)
            }
        }
        /// Outline color
        #[inline]
        pub fn outline_color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    PointsAnnotation::VT_OUTLINE_COLOR,
                    None,
                )
            }
        }
        ...
        pub fn outline_colors(
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color>>,
                >>(PointsAnnotation::VT_OUTLINE_COLORS, None)
            }
        }
        /// Fill color
        #[inline]
        pub fn fill_color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    PointsAnnotation::VT_FILL_COLOR,
                    None,
                )
            }
        }
        ...
        pub fn thickness(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(PointsAnnotation::VT_THICKNESS, Some(0.0))
                    .unwrap()
            }
        }
        /// Additional user-provided metadata associated with this annotation. Keys must be unique.
        ...
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair<'a>>>>
        {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
                >>(PointsAnnotation::VT_METADATA, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for PointsAnnotation<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Point2>>,
                >>("points", Self::VT_POINTS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Color>>(
                    "outline_color",
                    Self::VT_OUTLINE_COLOR,
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Color>>,
                >>("outline_colors", Self::VT_OUTLINE_COLORS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<Color>>(
                    "fill_color",
                    Self::VT_FILL_COLOR,
                    false,
    ...
    pub struct PointsAnnotationArgs<'a> {
        ...
        pub points: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point2<'a>>>,
            >,
        >,
        pub outline_color: Option<::flatbuffers::WIPOffset<Color<'a>>>,
        pub outline_colors: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color<'a>>>,
            >,
        >,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PointsAnnotationBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(PointsAnnotation::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: PointsAnnotationType) {
            self.fbb_.push_slot::<PointsAnnotationType>(
                PointsAnnotation::VT_TYPE_,
                type_,
                PointsAnnotationType::UNKNOWN,
            );
        ...
        pub fn add_points(
            &mut self,
            points: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Point2<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                PointsAnnotation::VT_POINTS,
                points,
            );
        }
        #[inline]
        ...
        #[inline]
        pub fn add_outline_colors(
            &mut self,
            outline_colors: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Color<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                PointsAnnotation::VT_OUTLINE_COLORS,
                outline_colors,
            );
        }
        #[inline]
        ...
        pub fn add_thickness(&mut self, thickness: f64) {
            self.fbb_
                .push_slot::<f64>(PointsAnnotation::VT_THICKNESS, thickness, 0.0);
        }
        #[inline]
        pub fn add_metadata(
            &mut self,
    ...
    pub fn root_as_points_annotation(
        buf: &[u8],
    ) -> Result<PointsAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_points_annotation(
        buf: &[u8],
    ) -> Result<PointsAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_points_annotation_unchecked(
        buf: &[u8],
    ) -> PointsAnnotation<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_points_annotation_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> PoseInFrame<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(PoseInFrame::VT_FRAME_ID, None)
            }
        }
        /// Pose in 3D space
        #[inline]
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(PoseInFrame::VT_POSE, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PoseInFrameBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(PoseInFrame::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                PoseInFrame::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(PoseInFrame::VT_POSE, pose);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> PoseInFrameBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            PoseInFrameBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_pose_in_frame(
        buf: &[u8],
    ) -> Result<PoseInFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_pose_in_frame(
        buf: &[u8],
    ) -> Result<PoseInFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_pose_in_frame_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<PoseInFrame<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> Pose<'a> {
        ...
        pub fn position(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(Pose::VT_POSITION, None)
            }
        }
        ...
        pub fn orientation(&self) -> Option<Quaternion<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Quaternion>>(Pose::VT_ORIENTATION, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PoseBuilder<'a, 'b, A> {
        ...
        pub fn add_position(&mut self, position: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(Pose::VT_POSITION, position);
        }
        #[inline]
    ...
    pub fn size_prefixed_root_as_pose(
        buf: &[u8],
    ) -> Result<Pose<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_pose_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Pose<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> PosesInFrame<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(PosesInFrame::VT_FRAME_ID, None)
            }
        }
        /// Poses in 3D space
        #[inline]
        pub fn poses(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Pose<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Pose>>,
                >>(PosesInFrame::VT_POSES, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for PosesInFrame<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Pose>>,
                >>("poses", Self::VT_POSES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct PosesInFrameArgs<'a> {
        ...
        pub poses: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Pose<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PosesInFrameBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(PosesInFrame::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                PosesInFrame::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_poses(
            &mut self,
            poses: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Pose<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(PosesInFrame::VT_POSES, poses);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> PosesInFrameBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            PosesInFrameBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_poses_in_frame(
        buf: &[u8],
    ) -> Result<PosesInFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_poses_in_frame(
        buf: &[u8],
    ) -> Result<PosesInFrame<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_poses_in_frame_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<PosesInFrame<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    pub fn root_as_quaternion(
        buf: &[u8],
    ) -> Result<Quaternion<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_quaternion(
        buf: &[u8],
    ) -> Result<Quaternion<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_quaternion_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Quaternion<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> RawAudio<'a> {
        ...
        pub fn format(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(RawAudio::VT_FORMAT, None)
            }
        }
        /// Sample rate in Hz
        #[inline]
        pub fn sample_rate(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(RawAudio::VT_SAMPLE_RATE, Some(0))
                    .unwrap()
            }
        }
        ...
        pub fn number_of_channels(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(RawAudio::VT_NUMBER_OF_CHANNELS, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RawAudioBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(RawAudio::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(RawAudio::VT_DATA, data);
        }
        #[inline]
        pub fn add_format(&mut self, format: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(RawAudio::VT_FORMAT, format);
        }
        #[inline]
        pub fn add_sample_rate(&mut self, sample_rate: u32) {
            self.fbb_
                .push_slot::<u32>(RawAudio::VT_SAMPLE_RATE, sample_rate, 0);
        }
        #[inline]
        pub fn add_number_of_channels(&mut self, number_of_channels: u32) {
            self.fbb_
                .push_slot::<u32>(RawAudio::VT_NUMBER_OF_CHANNELS, number_of_channels, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> RawAudioBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            RawAudioBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_raw_audio(
        buf: &[u8],
    ) -> Result<RawAudio<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_raw_audio_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<RawAudio<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> RawImage<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(RawImage::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn encoding(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(RawImage::VT_ENCODING, None)
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RawImageBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(RawImage::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(RawImage::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_width(&mut self, width: u32) {
        ...
        pub fn add_encoding(&mut self, encoding: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(RawImage::VT_ENCODING, encoding);
        }
        #[inline]
        ...
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(RawImage::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> RawImageBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            RawImageBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_raw_image(
        buf: &[u8],
    ) -> Result<RawImage<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_raw_image_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<RawImage<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl SceneEntityDeletionType {
        ...
        pub const ENUM_VALUES: &'static [Self] = &[Self::MATCHING_ID, Self::ALL];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
    ...
    impl<'a> SceneEntityDeletion<'a> {
        ...
        pub fn timestamp(&self) -> Option<&'a Time> {
            ...
            unsafe {
                self._tab
                    .get::<Time>(SceneEntityDeletion::VT_TIMESTAMP, None)
            }
        }
        ...
        pub fn type_(&self) -> SceneEntityDeletionType {
            ...
            unsafe {
                self._tab
                    .get::<SceneEntityDeletionType>(
                        SceneEntityDeletion::VT_TYPE_,
                        Some(SceneEntityDeletionType::MATCHING_ID),
                    )
                    .unwrap()
            }
        }
        ...
        pub fn id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(SceneEntityDeletion::VT_ID, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SceneEntityDeletionBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(SceneEntityDeletion::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_type_(&mut self, type_: SceneEntityDeletionType) {
            self.fbb_.push_slot::<SceneEntityDeletionType>(
                SceneEntityDeletion::VT_TYPE_,
                type_,
                SceneEntityDeletionType::MATCHING_ID,
            );
        ...
        pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntityDeletion::VT_ID, id);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> SceneEntityDeletionBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_scene_entity_deletion(
        buf: &[u8],
    ) -> Result<SceneEntityDeletion<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_scene_entity_deletion(
        buf: &[u8],
    ) -> Result<SceneEntityDeletion<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_scene_entity_deletion_unchecked(
        buf: &[u8],
    ) -> SceneEntityDeletion<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_scene_entity_deletion_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> SceneEntity<'a> {
        ...
        >(
            ...
            if let Some(x) = args.cylinders {
                builder.add_cylinders(x);
            }
            if let Some(x) = args.spheres {
                builder.add_spheres(x);
            }
            if let Some(x) = args.cubes {
                builder.add_cubes(x);
            }
            if let Some(x) = args.arrows {
                builder.add_arrows(x);
            }
            if let Some(x) = args.metadata {
                builder.add_metadata(x);
            }
            if let Some(x) = args.lifetime {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(SceneEntity::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(SceneEntity::VT_ID, None)
            }
        }
        ...
        pub fn frame_locked(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(SceneEntity::VT_FRAME_LOCKED, Some(false))
                    .unwrap()
            }
        }
        ...
        pub fn arrows(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ArrowPrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ArrowPrimitive>>,
                >>(SceneEntity::VT_ARROWS, None)
            }
        }
        /// Cube primitives
        #[inline]
        pub fn cubes(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CubePrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CubePrimitive>>,
                >>(SceneEntity::VT_CUBES, None)
            }
        }
        /// Sphere primitives
        #[inline]
        pub fn spheres(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SpherePrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SpherePrimitive>>,
                >>(SceneEntity::VT_SPHERES, None)
            }
        }
        /// Cylinder primitives
        #[inline]
        pub fn cylinders(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CylinderPrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CylinderPrimitive>>,
                >>(SceneEntity::VT_CYLINDERS, None)
            }
        }
        /// Line primitives
        #[inline]
        pub fn lines(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LinePrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LinePrimitive>>,
                >>(SceneEntity::VT_LINES, None)
            }
        }
        ...
        pub fn triangles(
            ...
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TriangleListPrimitive<'a>>>,
        > {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<TriangleListPrimitive>,
                    >,
                >>(SceneEntity::VT_TRIANGLES, None)
            }
        }
        /// Text primitives
        #[inline]
        pub fn texts(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextPrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextPrimitive>>,
                >>(SceneEntity::VT_TEXTS, None)
            }
        }
        /// Model primitives
        #[inline]
        pub fn models(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ModelPrimitive<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ModelPrimitive>>,
                >>(SceneEntity::VT_MODELS, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for SceneEntity<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                >>("metadata", Self::VT_METADATA, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<ArrowPrimitive>>,
                >>("arrows", Self::VT_ARROWS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<CubePrimitive>>,
                >>("cubes", Self::VT_CUBES, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<SpherePrimitive>>,
                >>("spheres", Self::VT_SPHERES, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<CylinderPrimitive>>,
                >>("cylinders", Self::VT_CYLINDERS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<LinePrimitive>>,
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<TextPrimitive>>,
                >>("texts", Self::VT_TEXTS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<ModelPrimitive>>,
    ...
    pub struct SceneEntityArgs<'a> {
        ...
        pub arrows: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ArrowPrimitive<'a>>>,
            >,
        >,
        pub cubes: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CubePrimitive<'a>>>,
            >,
        >,
        pub spheres: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SpherePrimitive<'a>>>,
            >,
        >,
        pub cylinders: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<CylinderPrimitive<'a>>>,
            >,
        >,
        pub lines: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LinePrimitive<'a>>>,
            >,
        >,
        pub triangles: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<TriangleListPrimitive<'a>>,
                >,
            >,
        >,
        pub texts: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TextPrimitive<'a>>>,
            >,
        >,
        pub models: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ModelPrimitive<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SceneEntityBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(SceneEntity::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                SceneEntity::VT_FRAME_ID,
                frame_id,
            );
        }
        #[inline]
        pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_ID, id);
        }
        #[inline]
        pub fn add_lifetime(&mut self, lifetime: &Duration) {
            self.fbb_
                .push_slot_always::<&Duration>(SceneEntity::VT_LIFETIME, lifetime);
        }
        #[inline]
        pub fn add_frame_locked(&mut self, frame_locked: bool) {
            self.fbb_
                .push_slot::<bool>(SceneEntity::VT_FRAME_LOCKED, frame_locked, false);
        }
        #[inline]
        pub fn add_metadata(
            &mut self,
        ...
        pub fn add_arrows(
            &mut self,
            arrows: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<ArrowPrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_ARROWS, arrows);
        }
        #[inline]
        pub fn add_cubes(
            &mut self,
            cubes: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<CubePrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_CUBES, cubes);
        }
        #[inline]
        pub fn add_spheres(
            &mut self,
            spheres: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<SpherePrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_SPHERES, spheres);
        }
        #[inline]
        pub fn add_cylinders(
            &mut self,
            cylinders: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<CylinderPrimitive<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                SceneEntity::VT_CYLINDERS,
                cylinders,
            );
        }
        #[inline]
        pub fn add_lines(
            ...
            lines: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<LinePrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_LINES, lines);
        }
        #[inline]
        pub fn add_triangles(
            ...
            triangles: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<TriangleListPrimitive<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                SceneEntity::VT_TRIANGLES,
                triangles,
            );
        }
        #[inline]
        pub fn add_texts(
            &mut self,
            texts: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<TextPrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_TEXTS, texts);
        }
        #[inline]
        pub fn add_models(
            &mut self,
            models: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<ModelPrimitive<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(SceneEntity::VT_MODELS, models);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> SceneEntityBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            SceneEntityBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_scene_entity(
        buf: &[u8],
    ) -> Result<SceneEntity<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_scene_entity(
        buf: &[u8],
    ) -> Result<SceneEntity<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_scene_entity_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<SceneEntity<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> SceneUpdate<'a> {
        ...
        >(
            ...
            if let Some(x) = args.deletions {
                builder.add_deletions(x);
            }
            builder.finish()
        }
        ...
        pub fn deletions(
            ...
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SceneEntityDeletion<'a>>>,
        > {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SceneEntityDeletion>>,
                >>(SceneUpdate::VT_DELETIONS, None)
            }
        }
        ...
        pub fn entities(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SceneEntity<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SceneEntity>>,
                >>(SceneUpdate::VT_ENTITIES, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for SceneUpdate<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<SceneEntityDeletion>>,
                >>("deletions", Self::VT_DELETIONS, false)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<SceneEntity>>,
    ...
    pub struct SceneUpdateArgs<'a> {
        ...
        pub entities: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SceneEntity<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SceneUpdateBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_deletions(
            &mut self,
            deletions: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<SceneEntityDeletion<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                SceneUpdate::VT_DELETIONS,
                deletions,
            );
        }
        #[inline]
        pub fn add_entities(
            ...
            entities: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<SceneEntity<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                SceneUpdate::VT_ENTITIES,
                entities,
            );
        }
        #[inline]
    ...
    pub fn root_as_scene_update(
        buf: &[u8],
    ) -> Result<SceneUpdate<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_scene_update(
        buf: &[u8],
    ) -> Result<SceneUpdate<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_scene_update_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<SceneUpdate<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> SpherePrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(SpherePrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn size(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(SpherePrimitive::VT_SIZE, None)
            }
        }
        /// Color of the sphere
        #[inline]
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(SpherePrimitive::VT_COLOR, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SpherePrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(SpherePrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_size(&mut self, size: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    SpherePrimitive::VT_SIZE,
                    size,
                );
        }
        #[inline]
    ...
    pub fn root_as_sphere_primitive(
        buf: &[u8],
    ) -> Result<SpherePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_sphere_primitive(
        buf: &[u8],
    ) -> Result<SpherePrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_sphere_primitive_unchecked(
        buf: &[u8],
    ) -> SpherePrimitive<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_sphere_primitive_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    impl<'a> TextAnnotation<'a> {
        ...
        >(
            ...
            if let Some(x) = args.text_color {
                builder.add_text_color(x);
            }
        ...
        pub fn text(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(TextAnnotation::VT_TEXT, None)
            }
        }
        /// Font size in pixels
        #[inline]
        pub fn font_size(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(TextAnnotation::VT_FONT_SIZE, Some(12.0))
                    .unwrap()
            }
        }
        /// Text color
        ...
        pub fn background_color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    TextAnnotation::VT_BACKGROUND_COLOR,
                    None,
                )
            }
        }
        ...
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair<'a>>>>
        {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KeyValuePair>>,
                >>(TextAnnotation::VT_METADATA, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TextAnnotationBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(TextAnnotation::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_position(&mut self, position: ::flatbuffers::WIPOffset<Point2<'b>>) {
            self.fbb_
        ...
        pub fn add_text(&mut self, text: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(TextAnnotation::VT_TEXT, text);
        }
        #[inline]
        pub fn add_font_size(&mut self, font_size: f64) {
            self.fbb_
                .push_slot::<f64>(TextAnnotation::VT_FONT_SIZE, font_size, 12.0);
        }
        #[inline]
        ...
        #[inline]
        pub fn add_background_color(
            &mut self,
            background_color: ::flatbuffers::WIPOffset<Color<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(
                    TextAnnotation::VT_BACKGROUND_COLOR,
    ...
    pub fn root_as_text_annotation(
        buf: &[u8],
    ) -> Result<TextAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_text_annotation(
        buf: &[u8],
    ) -> Result<TextAnnotation<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_text_annotation_unchecked(
        buf: &[u8],
    ) -> TextAnnotation<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_text_annotation_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<TextAnnotation<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> TextPrimitive<'a> {
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(TextPrimitive::VT_POSE, None)
            }
        }
        ...
        pub fn billboard(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(TextPrimitive::VT_BILLBOARD, Some(false))
                    .unwrap()
            }
        }
        ...
        pub fn font_size(&self) -> f64 {
            ...
            unsafe {
                self._tab
                    .get::<f64>(TextPrimitive::VT_FONT_SIZE, Some(0.0))
                    .unwrap()
            }
        }
        ...
        pub fn scale_invariant(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(TextPrimitive::VT_SCALE_INVARIANT, Some(false))
                    .unwrap()
            }
        }
        /// Color of the text
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Color>>(TextPrimitive::VT_COLOR, None)
            }
        }
        /// Text
        #[inline]
        pub fn text(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(TextPrimitive::VT_TEXT, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TextPrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(TextPrimitive::VT_POSE, pose);
        }
        #[inline]
        pub fn add_billboard(&mut self, billboard: bool) {
            self.fbb_
                .push_slot::<bool>(TextPrimitive::VT_BILLBOARD, billboard, false);
        }
        #[inline]
        pub fn add_font_size(&mut self, font_size: f64) {
            self.fbb_
                .push_slot::<f64>(TextPrimitive::VT_FONT_SIZE, font_size, 0.0);
        }
        #[inline]
        pub fn add_scale_invariant(&mut self, scale_invariant: bool) {
            self.fbb_
                .push_slot::<bool>(TextPrimitive::VT_SCALE_INVARIANT, scale_invariant, false);
        }
        #[inline]
        pub fn add_color(&mut self, color: ::flatbuffers::WIPOffset<Color<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Color>>(
                    TextPrimitive::VT_COLOR,
                    color,
                );
        }
        #[inline]
        pub fn add_text(&mut self, text: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(TextPrimitive::VT_TEXT, text);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> TextPrimitiveBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_text_primitive(
        buf: &[u8],
    ) -> Result<TextPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_text_primitive(
        buf: &[u8],
    ) -> Result<TextPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_text_primitive_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<TextPrimitive<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> TriangleListPrimitive<'a> {
        ...
        pub fn points(
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Point3>>,
                >>(TriangleListPrimitive::VT_POINTS, None)
            }
        }
        ...
        pub fn color(&self) -> Option<Color<'a>> {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<Color>>(
                    TriangleListPrimitive::VT_COLOR,
                    None,
                )
            }
        }
        ...
        pub fn colors(
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Color>>,
                >>(TriangleListPrimitive::VT_COLORS, None)
            }
        }
        /// Indices into the `points` and `colors` attribute arrays, which can be used to avoid duplicating attribute data.
        ///
        ...
        pub fn indices(&self) -> Option<::flatbuffers::Vector<'a, u32>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u32>>>(
                        TriangleListPrimitive::VT_INDICES,
                        None,
                    )
            }
        }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TriangleListPrimitiveBuilder<'a, 'b, A> {
        ...
        pub fn add_points(
            ...
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                TriangleListPrimitive::VT_POINTS,
                points,
            );
        }
        #[inline]
        ...
        pub fn add_colors(
            ...
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                TriangleListPrimitive::VT_COLORS,
                colors,
            );
        }
        #[inline]
        ...
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> TriangleListPrimitiveBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    pub fn root_as_triangle_list_primitive(
        buf: &[u8],
    ) -> Result<TriangleListPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_triangle_list_primitive(
        buf: &[u8],
    ) -> Result<TriangleListPrimitive<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn root_as_triangle_list_primitive_unchecked(
        buf: &[u8],
    ) -> TriangleListPrimitive<'_> {
    ...
    pub unsafe fn size_prefixed_root_as_triangle_list_primitive_unchecked(
        buf: &[u8],
    ) -> TriangleListPrimitive<'_> {
    ...
    #[inline]
    pub fn finish_size_prefixed_triangle_list_primitive_buffer<
        'a,
        'b,
        A: ::flatbuffers::Allocator + 'a,
    >(
    ...
    pub fn size_prefixed_root_as_vector_2(
        buf: &[u8],
    ) -> Result<Vector2<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_vector_2_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Vector2<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    pub fn size_prefixed_root_as_vector_3(
        buf: &[u8],
    ) -> Result<Vector3<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_vector_3_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<Vector3<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
    ...
    impl<'a> VoxelGrid<'a> {
        ...
        pub fn frame_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(VoxelGrid::VT_FRAME_ID, None)
            }
        }
        ...
        pub fn pose(&self) -> Option<Pose<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Pose>>(VoxelGrid::VT_POSE, None)
            }
        }
        /// Number of grid rows
        #[inline]
        pub fn row_count(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(VoxelGrid::VT_ROW_COUNT, Some(0))
                    .unwrap()
            }
        }
        /// Number of grid columns
        ...
        pub fn column_count(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(VoxelGrid::VT_COLUMN_COUNT, Some(0))
                    .unwrap()
            }
        }
        ...
        pub fn cell_size(&self) -> Option<Vector3<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Vector3>>(VoxelGrid::VT_CELL_SIZE, None)
            }
        }
        ...
        pub fn slice_stride(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(VoxelGrid::VT_SLICE_STRIDE, Some(0))
                    .unwrap()
            }
        }
        /// Number of bytes between rows in `data`
        ...
        pub fn row_stride(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(VoxelGrid::VT_ROW_STRIDE, Some(0))
                    .unwrap()
            }
        }
        /// Number of bytes between cells within a row in `data`
        ...
        pub fn cell_stride(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(VoxelGrid::VT_CELL_STRIDE, Some(0))
                    .unwrap()
            }
        }
        /// Fields in `data`. `red`, `green`, `blue`, and `alpha` are optional for customizing the grid's color.
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> VoxelGridBuilder<'a, 'b, A> {
        ...
        pub fn add_timestamp(&mut self, timestamp: &Time) {
            self.fbb_
                .push_slot_always::<&Time>(VoxelGrid::VT_TIMESTAMP, timestamp);
        }
        #[inline]
        pub fn add_frame_id(&mut self, frame_id: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(VoxelGrid::VT_FRAME_ID, frame_id);
        }
        #[inline]
        pub fn add_pose(&mut self, pose: ::flatbuffers::WIPOffset<Pose<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Pose>>(VoxelGrid::VT_POSE, pose);
        }
        #[inline]
        pub fn add_row_count(&mut self, row_count: u32) {
            self.fbb_
                .push_slot::<u32>(VoxelGrid::VT_ROW_COUNT, row_count, 0);
        }
        #[inline]
        pub fn add_column_count(&mut self, column_count: u32) {
            self.fbb_
                .push_slot::<u32>(VoxelGrid::VT_COLUMN_COUNT, column_count, 0);
        }
        #[inline]
        pub fn add_cell_size(&mut self, cell_size: ::flatbuffers::WIPOffset<Vector3<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Vector3>>(
                    VoxelGrid::VT_CELL_SIZE,
                    cell_size,
                );
        }
        #[inline]
        pub fn add_slice_stride(&mut self, slice_stride: u32) {
            self.fbb_
                .push_slot::<u32>(VoxelGrid::VT_SLICE_STRIDE, slice_stride, 0);
        }
        #[inline]
        pub fn add_row_stride(&mut self, row_stride: u32) {
            self.fbb_
                .push_slot::<u32>(VoxelGrid::VT_ROW_STRIDE, row_stride, 0);
        }
        #[inline]
        pub fn add_cell_stride(&mut self, cell_stride: u32) {
            self.fbb_
                .push_slot::<u32>(VoxelGrid::VT_CELL_STRIDE, cell_stride, 0);
        }
        #[inline]
        pub fn add_fields(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(VoxelGrid::VT_FIELDS, fields);
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(VoxelGrid::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> VoxelGridBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            VoxelGridBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn root_as_voxel_grid(
        buf: &[u8],
    ) -> Result<VoxelGrid<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_voxel_grid(
        buf: &[u8],
    ) -> Result<VoxelGrid<'_>, ::flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_voxel_grid_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
        fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        root: ::flatbuffers::WIPOffset<VoxelGrid<'a>>,
    ) {
        fbb.finish_size_prefixed(root, None);
